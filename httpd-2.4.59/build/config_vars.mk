exp_exec_prefix = /apache
rel_exec_prefix =
exp_bindir = /apache/bin
rel_bindir = bin
exp_sbindir = /apache/bin
rel_sbindir = bin
exp_libdir = /apache/lib
rel_libdir = lib
exp_libexecdir = /apache/modules
rel_libexecdir = modules
exp_mandir = /apache/man
rel_mandir = man
exp_sysconfdir = /apache/conf
rel_sysconfdir = conf
exp_datadir = /apache
rel_datadir =
exp_installbuilddir = /apache/build
rel_installbuilddir = build
exp_errordir = /apache/error
rel_errordir = error
exp_iconsdir = /apache/icons
rel_iconsdir = icons
exp_htdocsdir = /apache/htdocs
rel_htdocsdir = htdocs
exp_manualdir = /apache/manual
rel_manualdir = manual
exp_cgidir = /apache/cgi-bin
rel_cgidir = cgi-bin
exp_includedir = /apache/include
rel_includedir = include
exp_localstatedir = /apache
rel_localstatedir =
exp_runtimedir = /apache/logs
rel_runtimedir = logs
exp_logfiledir = /apache/logs
rel_logfiledir = logs
exp_proxycachedir = /apache/proxy
rel_proxycachedir = proxy
EGREP = /usr/bin/grep -E
PCRE_LIBS = -L/home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/apache/pcre2/lib -lpcre2-8
...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59/srclib/apr-util/libaprutil-1.la -lexpat /home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59/srclib/apr/libapr-1.la -lcrypt -lpthread
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
HTTPD_VERSION = 2.4.59
HTTPD_MMN = 20120211
abs_srcdir = /home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59
...
EXTRA_CFLAGS = -g -O2
EXTRA_CXXFLAGS =
EXTRA_LDFLAGS = -L/home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/apache/expat/lib
EXTRA_LIBS =
EXTRA_INCLUDES = -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/include -I/home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59/srclib/apr/include -I/home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59/srclib/apr-util/include -I/home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/apache/expat/include -I/home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/apache/pcre2/include -I$(top_srcdir)/modules/aaa -I$(top_srcdir)/modules/cache -I$(top_srcdir)/modules/core -I$(top_srcdir)/modules/database -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/ldap -I$(top_srcdir)/modules/loggers -I$(top_srcdir)/modules/lua -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/modules/http2 -I$(top_srcdir)/modules/session -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/test -I$(top_srcdir)/server -I$(top_srcdir)/modules/md -I$(top_srcdir)/modules/arch/unix -I$(top_srcdir)/modules/dav/main -I$(top_srcdir)/modules/generators -I$(top_builddir)/server -I$(top_srcdir)/modules/mappers
INTERNAL_CPPFLAGS =
LIBTOOL = /home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
SVN =
MODULE_DIRS = aaa cache core database debugging filters http loggers metadata proxy session slotmem ssl proxy/balancers arch/unix cluster dav/main generators dav/fs mappers
MODULE_CLEANDIRS = arch/win32 echo examples experimental ldap lua test http2 md tls dav/lock
PORT = 9001
SSLPORT = 443
CORE_IMPLIB_FILE =
CORE_IMPLIB =
...
APR_INCLUDEDIR = /home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59/srclib/apr/include
APR_VERSION = 1.7.4
APR_CONFIG = /apache/bin/apr-1-config
APU_BINDIR = /apache/bin
APU_INCLUDEDIR = /home/wanghan/Workspace/DASICS_ICT/DASICS-DEMO/demo-apache/httpd-apache/httpd-2.4.59/srclib/apr-util/include
APU_VERSION = 1.6.3
APU_CONFIG = /apache/bin/apu-1-config
